...
public class WithAttachmentMessage {
	...
	public MimeMessage createMessage(Session session) throws Exception {
		String from = "wuxc01@jsfund.cn"; // 2720554078@qq.com
		String to = "wuxc01@jsfund.cn"; // wuxinchenghappy@qq.com
		...
		MimeBodyPart attachment01 = createAttachment("D:\\wuxc\\pic\\pet291.jpg");
		MimeBodyPart content = createContent(body, "D:\\wuxc\\pic\\goretocat.png");
