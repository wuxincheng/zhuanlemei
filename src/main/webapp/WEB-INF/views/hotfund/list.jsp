...
<link data-turbolinks-track="true" href="${root}/assets/vendor/bootstrap/css/bootstrap.css" rel="stylesheet">
<link data-turbolinks-track="true" href="${root}/assets/css/hotfund.css" rel="stylesheet">
<script data-turbolinks-track="true" src="${root}/assets/js/jquery.min.js"></script>
<script data-turbolinks-track="true" src="${root}/assets/vendor/bootstrap/js/bootstrap.min.js"></script>
<script data-turbolinks-track="true" src="${root}/assets/vendor/bootstrap/js/npm.js"></script>
